...
const envSchema = z.object({
  ...
  MEDGEMMA_ENDPOINT: z.string().default("http://localhost:8000/v1/chat/completions"),
  MEDGEMMA_API_KEY: z.string().optional(),
  MEDGEMMA_MODEL: z.string().default("medgemma-1.5-4b"),
  MEDGEMMA_TIMEOUT_MS: z.coerce.number().default(30000),
  MEDGEMMA_RETRY_COUNT: z.coerce.number().default(2),
  MEDGEMMA_MAX_TOKENS: z.coerce.number().default(2048),
  MEDGEMMA_TEMPERATURE: z.coerce.number().default(0.1),
